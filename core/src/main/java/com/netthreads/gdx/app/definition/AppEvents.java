...
public class AppEvents
{
	...
	public static final int EVENT_PAD_TOUCH_DOWN = EVENT_BASE + 5;
	public static final int EVENT_PAD_TOUCH_DRAGGED = EVENT_BASE + 6;
	public static final int EVENT_PAD_TOUCH_UP = EVENT_BASE + 7;

	public static final int EVENT_NOTE_ON = EVENT_BASE + 8;
	public static final int EVENT_NOTE_OFF = EVENT_BASE + 9;
	
	public static final int EVENT_TICK = EVENT_BASE + 10;
	...
	public static final int EVENT_CONNECT_OSC_FAIL = EVENT_BASE + 13;
